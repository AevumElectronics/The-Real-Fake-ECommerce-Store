...
export default function CartPage() {
    ...
    return(
        <div className="py-5 bg-stone-100 p-20">
          ...
          <div className="bg-white flex justify-between gap-2 my-2  rounded-md shadow-md" key={id.toString()}>
            ...
            <div className="flex pl-5">
              ...
              <div className="my-auto border-2 h-10  flex px-1 rounded-md">
                <button onClick={()=>item.quantity>1 && dispatch(adjustQuantity(item.id, item.quantity-1))}>
                  <MinusSmIcon className="w-5 stroke-1 text-zinc-700 rounded-md
                   hover:bg-red-300 hover:shadow-md hover:text-zinc-900 "/>
                </button>
              ...
              <div className="my-auto px-5">
                ...
                className="w-10 my-auto hover:bg-red-300 hover:rounded-md hover:shadow-md
                  stroke-1 text-zinc-800"/></button>
              </div>
            </div>
